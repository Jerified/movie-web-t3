  ...
  return (
    <div className='pt-4'>
        ...
        <div className=" w-full relative">
            ...
            <div className="">
              <div className="bg-black rounded-full opacity-60 w-fit p-2 absolute top-3 right-4 cursor-pointer fill-white"><BsBookmark className='stroke-1 w-[1.18rem] fill-white' /></div>
              <div className="">
